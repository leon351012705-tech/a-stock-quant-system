...
> 🖼 **作品集 PPT**：[`demo/量化系统作品集.pptx`](demo/)
...
这个 README 花了很大篇幅写 [**第六节：AI 协作开发实录**](#六ai-协作开发实录)——因为对我来说，"怎么和 AI 一起把它做出来"，比"它本身"更值得讲。整个系统从架构设计、性能优化、bug 排查到 A/B 实验验证，全程是 **Prompt 驱动 + AI 工作流**的产物。
